...
// ompnn - OpenMP feed-forward neural network library (1:1 port of syclnn)
...
#define OMPNN_VERSION_MAJOR 0
#define OMPNN_VERSION_MINOR 1
#define OMPNN_VERSION_PATCH 0
#define OMPNN_VERSION_STRING "0.1.0"
